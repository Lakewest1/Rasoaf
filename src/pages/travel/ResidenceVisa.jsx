    ...
    try {
      ...
      const response = await fetch(FORMSPREE_ENDPOINT, {
        ...
        body: JSON.stringify({
          ...
          familyMembers: formData.familyMembers || "N/S",
          message: formData.message || "N/A",
          // Metadata
          _subject: `New Residence Visa Enquiry from ${formData.firstName} ${formData.lastName}`,
          _replyto: formData.email,
          formType: "Residence Visa",
      ...
      setTimeout(() => {
        setSubmitted(false);
        setFormData({ firstName: "", lastName: "", email: "", phoneCode: "+234", phone: "", destination: "", residenceType: "", familyMembers: "", message: "" });
      }, 6000);
    } catch (err) {
