...
// v4: Formspree .env integration · Proven payload format · All content preserved
// ─────────────────────────────────────────────────────────────────────────────
...
// ══════════════════════════════════════════════════════════════════════════
const FORMSPREE_ENDPOINT = import.meta.env.VITE_FORMSPREE_TOURIST_VISA || "";
...
// ══════════════════════════════════════════════════════════════════════════
//  TOURIST VISA FORM — With Proven Formspree Integration
// ══════════════════════════════════════════════════════════════════════════
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const sd = { 
        ...
        phone: fp,
        message: `Tourist Visa Enquiry\n\nName: ${formData.firstName} ${formData.lastName}\nEmail: ${formData.email}\nPhone: ${fp}\nDestination: ${formData.destination}\nPurpose: ${formData.travelPurpose || "N/S"}\nDeparture: ${formData.departureDate}\nReturn: ${formData.returnDate || "N/S"}\nAdults: ${formData.adults}\nChildren: ${formData.children}\nMessage: ${formData.message || "N/A"}`
      };
