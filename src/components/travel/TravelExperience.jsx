...
// ─────────────────────────────────────────────────────────────────────────────
// RASOAF TRAVELS AND TOURS LIMITED — Enterprise Featured Experiences (v3.4)
...
// ══════════════════════════════════════════════════════════════════════════
// Enterprise CSS with Earth-Shaped Cards - Black Gradient Background
// ══════════════════════════════════════════════════════════════════════════
const STYLES = `
  .rte-section {
    --rte-gold: ${COLORS.gold};
    --rte-gold-light: ${COLORS.goldLight};
    --rte-gold-dark: ${COLORS.goldDark};
    --rte-white: ${COLORS.white};
    --rte-cream: ${COLORS.cream};
    --rte-text-dark: ${COLORS.textDark};
    --rte-text-grey: ${COLORS.textGrey};
    --rte-text-muted: ${COLORS.textMuted};
    --rte-text-dim: ${COLORS.textDim};
    --rte-font-display: ${TYPOGRAPHY.display};
    --rte-font-body: ${TYPOGRAPHY.body};
  }
  ...
  /* ═══════════════════════════════════════════════════════════════════════ */
  /* SECTION · Premium Black Gradient Background                          */
  /* ═══════════════════════════════════════════════════════════════════════ */
  ...
  .rte-title-gradient {
    background: linear-gradient(
      135deg, 
      var(--rte-gold-light) 0%, 
      var(--rte-gold) 40%, 
      var(--rte-gold-dark) 100%
    );
  ...
  /* ═══════════════════════════════════════════════════════════════════════ */
  /* DESKTOP/TABLET GRID · Centered Earth Orbit Layout                    */
  /* ═══════════════════════════════════════════════════════════════════════ */
  ...
  .rte-carousel-arrow.prev { left: 4px; }
  .rte-carousel-arrow.next { right: 4px; }
  ...
  .rte-earth-orbit {
    ...
    animation: rte-orbit-rotate 20s linear infinite;
    pointer-events: none;
  }
  ...
  .rte-earth-wrapper:hover .rte-earth-glow {
    opacity: 0.7;
    animation: rte-glow-pulse 2s ease-in-out infinite;
  }
  ...
  /* Main Earth card - circular · DARK DEFAULT · WHITE ON HOVER */
  .rte-earth-card {
    position: relative;
    width: 100%;
    height: 100%;
  ...
  /* Continent-like texture overlay */
  ...
  .rte-earth-icon-ring::before {
    ...
    animation: rte-icon-orbit 8s linear infinite;
  ...
  /* Title — Light on dark → Dark on white */
  .rte-earth-title {
    font-family: var(--rte-font-display);
    font-weight: 800;
  ...
  /* Description — Light on dark → Dark on white */
  .rte-earth-desc {
    font-family: var(--rte-font-body);
  ...
  /* Stat badge — Dark with subtle border → Gold accent on white */
  .rte-earth-stat {
    font-family: var(--rte-font-body);
    font-size: 0.68rem;
    font-weight: 700;
  ...
  @media (min-width: 1920px) {
    ...
    .rte-grid { max-width: 1300px; gap: clamp(48px, 6vw, 80px) clamp(32px, 4vw, 56px); }
  ...
  @media (min-width: 1600px) and (max-width: 1919px) {
    ...
    .rte-grid { max-width: 1200px; gap: clamp(44px, 5.5vw, 72px) clamp(28px, 3.5vw, 48px); }
    .rte-earth-wrapper { max-width: 340px; }
  }

  /* Desktop · 1440px to 1599px */
  @media (min-width: 1440px) and (max-width: 1599px) {
    .rte-grid { max-width: 1150px; gap: clamp(40px, 5vw, 64px) clamp(24px, 3vw, 40px); }
    .rte-earth-wrapper { max-width: 330px; }
  }

  /* Standard Desktop · 1280px to 1439px */
  @media (min-width: 1280px) and (max-width: 1439px) {
    .rte-grid { max-width: 1080px; gap: clamp(36px, 4.5vw, 56px) clamp(22px, 2.8vw, 36px); }
    .rte-earth-wrapper { max-width: 310px; }
  }

  /* Small Desktop · 1024px to 1279px */
  @media (min-width: 1024px) and (max-width: 1279px) {
    .rte-container { max-width: 1100px; }
    .rte-grid { max-width: 960px; gap: clamp(28px, 3.5vw, 44px) clamp(18px, 2.2vw, 28px); }
    .rte-earth-wrapper { max-width: 280px; }
  }

  /* Tablet Landscape · 820px to 1023px */
  @media (min-width: 820px) and (max-width: 1023px) {
    .rte-grid { grid-template-columns: repeat(3, 1fr); max-width: 780px; gap: clamp(24px, 3vw, 36px) clamp(16px, 2vw, 24px); }
    .rte-earth-wrapper { max-width: 240px; }
    .rte-earth-card { padding: clamp(18px, 6%, 28px); }
    .rte-earth-orbit { inset: -8px; }
  }

  /* Tablet Portrait · 768px to 819px */
  @media (min-width: 768px) and (max-width: 819px) {
    .rte-grid { grid-template-columns: repeat(2, 1fr); max-width: 640px; gap: clamp(32px, 5vw, 48px) clamp(24px, 3.5vw, 36px); }
    .rte-earth-wrapper { max-width: 300px; }
  }

  /* Large Mobile · 600px to 767px */
  @media (min-width: 600px) and (max-width: 767px) {
    .rte-grid { grid-template-columns: repeat(2, 1fr); max-width: 520px; gap: clamp(24px, 4vw, 36px) clamp(16px, 2.5vw, 24px); }
    .rte-earth-wrapper { max-width: 250px; }
    .rte-earth-card { padding: clamp(16px, 5%, 24px); }
    .rte-earth-orbit { display: none; }
  }

  /* Mobile · Show Carousel */
  @media (max-width: 599px) {
    .rte-grid-wrapper { display: none !important; }
    .rte-carousel { display: block; }
    .rte-section { padding: clamp(40px, 6vh, 64px) 12px; }
    .rte-container { padding: 0 8px; }
    .rte-header { margin-bottom: clamp(32px, 5vh, 48px); }
    .rte-title { font-size: clamp(28px, 5.5vw, 38px); }
    .rte-earth-wrapper { max-width: 340px; margin: 0 auto; }
    .rte-earth-card { padding: clamp(20px, 7%, 32px); }
  }

  /* Medium Mobile · 430px to 599px */
  @media (min-width: 430px) and (max-width: 599px) {
    .rte-earth-wrapper { max-width: 320px; }
    .rte-carousel { max-width: 380px; }
  }

  /* Small Mobile · 375px to 429px */
  @media (min-width: 375px) and (max-width: 429px) {
    .rte-earth-wrapper { max-width: 300px; }
    .rte-carousel { max-width: 360px; }
    .rte-carousel-slide { padding: 16px 20px; }
  }

  /* Extra Small Mobile · 320px to 374px */
  @media (min-width: 320px) and (max-width: 374px) {
    .rte-earth-wrapper { max-width: 260px; }
    .rte-carousel { max-width: 320px; }
    .rte-earth-card { padding: clamp(16px, 6%, 24px); }
    .rte-carousel-slide { padding: 12px 16px; }
    .rte-carousel-arrow { width: 36px; height: 36px; }
    .rte-earth-orbit { display: none; }
    .rte-header-decoration { gap: 8px; }
    .rte-header-line { width: 16px; }
    .rte-badge { padding: 6px 14px; font-size: 9.5px; gap: 6px; }
  }
  ...
  @media (hover: none) and (pointer: coarse) {
    ...
    .rte-earth-card:active .rte-earth-title {
      color: var(--rte-text-dark);
      text-shadow: none;
    }
    .rte-earth-card:active .rte-earth-desc {
      color: var(--rte-text-grey);
    }
    .rte-earth-card:active .rte-earth-stat {
      background: rgba(212, 160, 23, 0.08);
      color: var(--rte-gold-dark);
      border-color: rgba(212, 160, 23, 0.2);
    }
  ...
  @media print {
    ...
    .rte-grid-wrapper { display: block !important; }
        ...
        <div className="rte-earth-content">
          ...
          >
            <div className="rte-earth-icon">
              <Icon size={iconSize} color={experience.color} strokeWidth={1.8} />
            </div>
          </div>
  ...
  return (
    ...
    >
      <div className="sr-only" role="status" aria-live="polite">
        Showing experience {current + 1} of {items.length}: {items[current].title}
      </div>
      ...
      <motion.div
        ...
        transition={prefersReducedMotion ? { duration: 0 } : {
          type: "spring", stiffness: 250, damping: 35, mass: 1,
        }}
      >
        {items.map((item, idx) => (
      ...
      <button className="rte-carousel-arrow prev" onClick={() => { prev(); startTimer(); }} aria-label="Previous experience" type="button">
        <ChevronLeft size={20} />
      </button>
      <button className="rte-carousel-arrow next" onClick={() => { next(); startTimer(); }} aria-label="Next experience" type="button">
      ...
      <div className="rte-carousel-dots" role="tablist" aria-label="Experience navigation">
        {items.map((item, i) => (
          <button
            key={item.id}
            className={`rte-carousel-dot ${i === current ? "active" : ""}`}
          ...
          >
            <div className="rte-header-decoration">
              ...
              <span className="rte-badge">
                <Compass size={12} className="rte-badge-icon" aria-hidden="true" />
                Curated Experiences
                <Sparkles size={12} className="rte-badge-icon" aria-hidden="true" />
              </span>
              <div className="rte-header-line" aria-hidden="true" />
            </div>
