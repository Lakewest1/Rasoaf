...
export default function VisaSlider() {
  ...
  return (
    ...
    >
      ...
      {/* Background Image - SMOOTH GRADUAL SLIDE from RIGHT */}
      ...
      <div style={{
        ...
        minHeight: isMobile ? "85vh" : "75vh",
        textAlign: "center",
        padding: isMobile ? "80px 20px 40px" : "60px 24px",
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div style={{
              ...
              fontSize: isMobile ? "10px" : "clamp(10px, 0.8vw, 12px)",
              fontWeight: 700,
            ...
            <p style={{
              fontFamily: typography.body,
              fontSize: isMobile ? "clamp(13px, 3.5vw, 15px)" : "clamp(14px, 1.2vw, 16px)",
              fontWeight: 400,
              lineHeight: 1.65,
            ...
            <button
              ...
              style={{
                ...
                fontFamily: typography.body,
                fontSize: isMobile ? "13px" : "clamp(14px, 0.95vw, 15px)",
                fontWeight: 700,
